        ...
        <div className="container ">
          ...
          <div className="col-12">
            <p>
              ...
              <ul>
                <li>
                  The professional can search for jobs in their area of
                  expertise;
                </li>
                <li>
                  The client can look for the solution to his problem and find
                  the professional who can best do it.
                </li>
              </ul>
              <br />
              ...
              <br />
              <br />
              So you as a professional can create your profile for free and
              start offering your services, if your profile is approved in
              HireMySkills
              <br />
              <br />
            ...
            <p id="client">
              ...
              interest, that adapts to your needs and with the best offers in
              the labor market.
              <br />
            ...
            <p id="contract">
              ...
              project for hours, you must validate your payment method. From
              this you can start working.
              <br />
              To end the work, all that remains is for both to qualify. This
              qualification is confidential, you will only be able to see how
              the chosen professional has qualified you after you have already
              issued your qualification.
            </p>
            <br />
            <br />
            <hr />
            ...
            <p id="professional">
              ...
              it! If you have a skill that you can offer and benefit someone
              else with your knowledge, don't wait any longer! and register on
              our platform,
              <br />
