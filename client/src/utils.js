...
export const POST_PROFESSIONALS = "POST_PROFESSIONALS";
...
export const urlReviews = "http://localhost:4000/reviews";
export const urlShoppingcart = "http://localhost:4000/shoppingcart";
